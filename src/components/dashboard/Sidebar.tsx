...
export const DashboardSidebar = ({ labels, labelCounts, counts, filter }: DashboardSidebarProps) => {
    ...
    <aside class="hidden lg:flex w-64 border-r border-slate-200 dark:border-slate-800 flex-col h-screen sticky top-0 bg-background-light dark:bg-background-dark">
      ...
      <div class="p-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xs text-primary font-medium" id="version-info">Loading...</p>
        </div>
      </div>
      ...
      <div class="p-4 border-t border-slate-200 dark:border-slate-800">
        ...
        <div class="mt-4 flex items-center gap-3 px-2">
          ...
          <div class="flex-1 min-w-0">
            ...
            <p class="text-[10px] text-slate-500" id="hostname-info">localhost</p>
          </div>
          <a href="/settings">

  ...
  return (
    <tr class="hover:bg-slate-50/50 dark:hover:bg-background-dark/20 transition-colors group cursor-pointer select-none touch-callout-none" data-hash={torrent.hash}>
      ...
      <td class="px-4 py-4 text-right">
        <button class="row-action-btn p-1.5 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg text-slate-400 hover:text-primary transition-all" data-hash={torrent.hash}>
